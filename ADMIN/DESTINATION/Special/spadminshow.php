...
<body>
    <center>
        <h2>Special Trips Information</h2>
    </center>
    <table border="1" align="center">
        ...
        <?php
        $ctr = 1;
        $sql2 = "SELECT * FROM packages ORDER BY id";
    ...
    <script>
        $(document).ready(function() {
            $(".status-indicator").on("click", function() {
                ...
                var form = $('<form action="http://localhost/tt/ADMIN/DESTINATION/Special/update_status.php" method="post"></form>');
