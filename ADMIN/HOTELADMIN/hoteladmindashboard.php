...
<BODY>
    ...
    <div id="dashboard">
        <div id="sidebar">
            <h2>HOTELS</h2>
            <ul>
                <li class="custom-li custom-li-1"><A HREF="hotelinstform.php" target="cont">ADD</A></li>
                <li class="custom-li custom-li-3"><A HREF="hoteladminshow.php" target="cont">LIST</A></li>
            </ul>
        </div>
