...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateSql = "UPDATE hotels SET hotel_availability = '$newStatus' WHERE hotel_id = '$tripId'";
    $updateResult = mysqli_query($con, $updateSql);

    // Check if the update was successful
    if ($updateResult) {
        header("Location: http://localhost/tt/admin/hoteladmin/hoteladminshow.php"); // Redirect back to the original page
        exit();
    } else {
